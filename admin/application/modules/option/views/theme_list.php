						...
						<table class="table table-striped table-hover display nowrap" id="videos-list">
							<thead>
								...
								<tr>
									...
									<td class="text-right">
									<a class="btn ink-reaction btn-raised btn-primary btn-sm" href="<?php echo site_url('option/theme/add'); ?>"><span class="fa fa-plus"></span> Add Theme</a></td>
									...
									<?php foreach($category as $key => $value){ ?>
										<tr>
											...
											<td class="text-right">
												...
												<a class="btn ink-reaction btn-primary" href="<?php echo site_url('option/theme/edit').'/'.$value['id']; ?>">
											...
											<?php }else{ ?>
												<a class="btn ink-reaction btn-primary" onclick="deleteProduct('<?php echo site_url('option/theme/delete').'/'.$value['id']; ?>')">
...
<script>
	function filter(){
			...
			url = '<?php echo site_url('option/theme'); ?>/'; //'<?php echo current_url(); ?>';
