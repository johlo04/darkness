						...
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									<label class="col-sm-4" for="Firstname5">Search<br/>Video Content Name</label>
									<div class="col-sm-6">
						...
						<table class="table table-striped table-hover display nowrap" id="videos-list">
							<thead>
								...
								<tr>
									...
									<td>Status</td>
									<td class="text-right">
									<a class="btn ink-reaction btn-raised btn-primary btn-sm" href="<?php echo site_url('option/vidcontent/add'); ?>"><span class="fa fa-plus"></span> Add Video Scene</a></td>
									...
									<?php foreach($category as $key => $value){ ?>
										<tr>
											...
											<td class="text-right">
												...
												<a class="btn ink-reaction btn-primary" href="<?php echo site_url('option/vidcontent/edit').'/'.$value['id']; ?>">
											...
											<?php }else{ ?>
												<a class="btn ink-reaction btn-primary" onclick="deleteProduct('<?php echo site_url('option/vidcontent/delete').'/'.$value['id']; ?>')">
...
<script>
	function filter(){
			...
			url = '<?php echo site_url('option/vidcontent'); ?>/'; //'<?php echo current_url(); ?>';
