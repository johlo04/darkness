								...
								<div class="card-body tab-content">
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<select class="form-control" name="type">
																	...
																	<option value="main" <?php echo ($rowdata['type']=='main')? 'selected="selected"': ''; ?> >Main Category</option>
																	<option value="sub" <?php echo ($rowdata['type']=='sub')? 'selected="selected"': ''; ?> >Sub Category</option>
																</select>
																<?php }else{ ?>
																		<div class="form-control" ><i class="md md-lock"></i> <?php echo ucwords($rowdata['type']); ?> Category</div>
																<?php } ?>
																<label for="">
																	Type
																</label>
										...
										<div class="form-group col-md-12">
											<div class="text-right pull-right col-md-2">
												...
												<a href="<?php echo site_url('option/category'); ?>"><div class="btn btn-default-bright">Back</div></a>
											</div>
										</div>
