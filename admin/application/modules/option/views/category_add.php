													...
													<div class="tab_content ">
														...
														<div class="col-md-6">
															<div class="form-group <?php echo (form_error('en_keyword'))? 'has-error': ''; ?>">
																<input class="form-control" id="en_keyword" name="en_keyword" value="<?php echo set_value('en_keyword'); ?>" type="text" placeholder=""  />
															...
															<div class="form-group <?php echo (form_error('jp_keyword'))? 'has-error': ''; ?>">
																<input class="form-control" id="jp_keyword" name="jp_keyword" value="<?php echo set_value('jp_keyword'); ?>" type="text" placeholder=""  />
															...
															<div class="form-group">
																<input class="form-control" id="sort_order" name="sort_order" value="<?php echo set_value('sort_order'); ?>" type="text" placeholder=""  />
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<select class="form-control" name="type">
																	...
																	<option value="main" <?php echo ($type=='main')? 'selected="selected"': ''; ?> >Main Category</option>
																	<option value="sub" <?php echo ($type=='sub')? 'selected="selected"': ''; ?> >Sub Category</option>
																</select>
