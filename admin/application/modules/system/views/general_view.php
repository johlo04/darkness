							...
							<div class="card">
								...
								<div class="card-body tab-content">
										...
										<div id="first1" class="tab-pane active">				
											...
											<?php echo form_close();  //fp($rowdata_all);?>
											
											<?php foreach($rowdata_all as $value){ ?>
												<div class="<?php echo $value['holder_class']; ?>">
													<div class="form-group">
														<label for=""><?php echo configNameCleaner($value['config_name']); ?></label>
														<?php echo customField($value['form_type'],$value['config_name'],$value['value'],$value['data_opt']); ?>
													</div>
												</div>
