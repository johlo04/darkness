													...
													<div id="general" class="tab_content">
														...
														<div class="col-md-6">
															<div class="form-group">
																<input class="form-control" id="text_label" name="text_label" value="<?php echo set_value('text_label'); ?>" type="text" placeholder="Banner Label"  />
															...
															<div class="form-group">
																<input class="form-control" id="link" name="link" value="<?php echo set_value('link',''); ?>" type="text" placeholder="Link"  />
																<label for="link">
																	Link
																</label>
															</div>
															...
															<div class="form-group">
																<input class="form-control" id="sort_order" name="sort_order" value="<?php echo set_value('sort_order',''); ?>" type="number" min="0" placeholder="Sort Order"  />
														...
														<div class="col-md-6">
															...
															<div class="form-group <?php echo (form_error('image'))? 'has-error': ''; ?>">
																	...
																	<input class="form-control" id="banner_image" name="image" value="<?php echo set_value('image'); ?>" type="hidden"  />
																	<br/>
																	<div class="thumbnail">
																	
																		<img src="<?php echo (!empty($image))? $image : URL_FILEMANAGER_SOURCE.'no_image.jpg'; ?>" id="banner_image_preview" class="img-responsive" style="max-height:354px">
