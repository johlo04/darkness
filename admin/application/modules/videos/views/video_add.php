							...
							<div class="card">
								...
								<div class="card-body tab-content">
												...
												<div class="tab_content ">
																...
																<div class="tab-pane <?php echo ($lang['id']==1)? 'active': ''; ?>" id="lang<?php echo $lang['id']; ?>">
																	<div class="col-md-6">
																		...
																		<div class="form-group <?php echo (form_error('description['.$lang['id'].'][title]'))? 'has-error': ''; ?>">
																			<input class="form-control" name="description[<?php echo $lang['id']; ?>][title]" value="<?php echo set_value('description['.$lang['id'].'][title]'); ?>" type="text" placeholder="Video Title"  />
														...
														<div class="col-md-6">
															<div class="form-group <?php echo (form_error('video_duration'))? 'has-error': ''; ?>">
																<input class="form-control" id="video_duration" name="video_duration" value="<?php echo set_value('video_duration'); ?>" type="text" placeholder="Video Lenght Format"  />
																<label for="video_duration">
																	Full Video Time Lenght/Duration<span class="text-danger">*</span> <b>ex: 01:24:00</b>
																</label>
														...
														<div class="col-md-6">
															...
															<div class="form-group">
																...
																<label for="client_name">
																	<span class="fa fa-photo"></span> Cover Image
																	<span class="help">
														...
														<div class="col-md-6">	
															<div class="form-group">
																<?php  $poster_image = set_value('poster_image'); ?>
																
																<input class="form-control" id="poster_image" name="poster_image" value="<?php echo set_value('poster_image'); ?>" type="hidden"  />
																<br/>
																<div class="thumbnail">
																
																	<img src="<?php echo (!empty($poster_image))? $poster_image : URL_FILEMANAGER_SOURCE.'no_image.jpg'; ?>" id="poster_image_preview" class="img-responsive" style="max-height:354px">
														...
														<div class="col-md-6">	
															<div class="form-group">
																<?php  $banner_image = set_value('banner_image'); ?>
																
																<input class="form-control" id="banner_image" name="banner_image" value="<?php echo set_value('banner_image'); ?>" type="hidden"  />
																<br/>
																<div class="thumbnail">
																
																	<img src="<?php echo (!empty($banner_image))? $banner_image : URL_FILEMANAGER_SOURCE.'no_image.jpg'; ?>" id="banner_image_preview" class="img-responsive" style="max-height:354px">
														...
														<div class="col-md-12">
															<?php /*<div class="panel-group" id="accordion1">
															...
															*/ ?>
															...
															<div class="panel-group" id="accordion2">
																<div class="card panel">
																	...
																	<div id="accordion2-1" class="collapse in" aria-expanded="false">
																		<?php 
															...
															<div class="panel-group" id="accordion3">
																<div class="card panel">
																	...
																	<div id="accordion3-1" class="collapse in" aria-expanded="false">
										...
										<div id="video" class="tab-pane" >
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="samplevideo1" name="clip_mp4" value="<?php echo set_value('clip_mp4'); ?>" type="text"><div class="form-control-line"></div>
														</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="samplevideo2" name="clip_webm" value="<?php echo set_value('clip_webm'); ?>" type="text"><div class="form-control-line"></div>
														</div>
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="samplevideo3" name="clip_ogv" value="<?php echo set_value('clip_ogv'); ?>" type="text"><div class="form-control-line"></div>
														</div>
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="fullvideo1" name="full_mp4" value="<?php echo set_value('full_mp4'); ?>" type="text"><div class="form-control-line"></div>
														</div>
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="fullvideo2" name="full_webm" value="<?php echo set_value('full_webm'); ?>" type="text"><div class="form-control-line"></div>
														</div> 
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="fullvideo3" name="full_ogv" value="<?php echo set_value('full_ogv'); ?>" type="text"><div class="form-control-line"></div>
														</div>
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="viddownload1" name="fullhd" value="<?php echo set_value('fullhd'); ?>" type="text"><div class="form-control-line"></div>
														</div> 	 	 	
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="viddownload2" name="hdlite" value="<?php echo set_value('hdlite'); ?>" type="text"><div class="form-control-line"></div>
														</div>
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="viddownload3" name="mobile" value="<?php echo set_value('mobile'); ?>" type="text"><div class="form-control-line"></div>
														</div>
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
											...
											<span class="help">
												Note: Downloadable video must be MP4/VLC/MOV ( <b class="text-danger">NEVER</b> allow user to download ogv,webm)
												<br/>
												VR videos please choose supported VR file extension only. (  MP4 )
											</span>
										</div>
										...
										<div id="vcontent" class="tab-pane" >
											...
											<hr/>
											<b class="danger">VR DOES NOT SUPPORT THE VIDEO TIME FUNCTION.</b> Leave it blank for now.
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="galdownload1" name="scene_zip" value="<?php echo set_value('scene_zip'); ?>" type="text"><div class="form-control-line"></div>
														</div>
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
										...
										<div id="gallery" class="tab-pane" >
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<div class="input-group-content">
															<input class="form-control" id="galdownload2" name="gallery_zip" value="<?php echo set_value('gallery_zip'); ?>" type="text"><div class="form-control-line"></div>
														</div>
														<div class="input-group-btn">
															<button type="button" class="btn btn-default" tabindex="-1">Action</button>
															<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" tabindex="-1" aria-expanded="false">
										...
										<span class="help">No comments yet for new video post.</div>
										</div>
